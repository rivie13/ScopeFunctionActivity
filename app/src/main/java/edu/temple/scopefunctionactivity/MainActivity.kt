...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("function output", getTestDataArray2().toString())
        Log.d("function output: ", averageLessThanMedian2(getTestDataArray2()).toString())
        Log.d("function output",
            getView2(position = 1, recycledView = null, collection = getTestDataArray2(), context = this).toString()
        )
    }
    ...
    private fun averageLessThanMedian2(listOfNumbers: List<Int>): Boolean =
